...
@section('content')
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-xl font-bold text-[#1A1A1A]">Edit Data Obat</h2>
            <p class="text-xs text-[#9E9E9E] mt-0.5">Ubah informasi obat pertanian di bawah ini untuk diperbarui pada aplikasi mobile.</p>
        </div>
    </div>
    ...
    @if($errors->any())
        <div class="mb-5 flex items-start gap-3 bg-danger-50 border border-danger-400/30 text-danger-700 px-4 py-3 rounded-xl text-sm">
            ...
            <div>
                <p class="font-semibold text-xs">Pembaruan obat gagal</p>
        ...
        <form method="POST" action="{{ route('admin.obat.update', $obat['id']) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                @php
                                    $currentStatus = old('status', $obat['status'] ?? 'Aktif');
                                @endphp
                ...
                <div class="space-y-4">
                    ...
                    <div x-data="imagePreview('{{ $obat['gambar'] ?? '' }}')" class="space-y-3">
                        {{-- Image Display Area --}}
                        <div class="w-full aspect-[4/3] rounded-2xl bg-[#F8F9FA] border-2 border-dashed border-[#E0E0E0] overflow-hidden flex items-center justify-center relative group">
                            ...
                            <div x-show="!imageUrl" class="flex flex-col items-center justify-center p-6 text-center">
                                ...
                                <span class="text-xs text-[#9E9E9E] font-medium">Klik atau tarik file ke sini untuk mengupload gambar baru</span>
                            </div>
                        ...
                        <p class="text-[11px] text-[#9E9E9E] leading-relaxed">
                            Pilih file baru jika Anda ingin mengganti gambar saat ini. Maksimal ukuran file 2 MB.
                        </p>
                    </div>
                </div>
